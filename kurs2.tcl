...
proc pub:currency {n u h c t} {
 ...
 if {![dict exists $kursjson $from]} {putnow "privmsg $c :\0034ERROR:\003 \002[string toupper $from]\002 tidak tersedia"; return} {set kursfrom [dict get $kursjson $from inverseRate]}
