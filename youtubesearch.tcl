...
proc pub:ytsearch {n u h c t} {
 ...
 if {[catch {set ytpage [http::geturl "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=5&regionCode=id&safeSearch=none&type=video&key=$apikey&[http::formatQuery q $text]" -timeout 60000]} error]} {putnow "privmsg $c :$error" ; return}
