...
proc pub:gempa {n u h c t} {
 ...
 set gempa [dict get $response Infogempa gempa] ; foreach data {Tanggal Jam Coordinates Lintang Bujur Magnitude Kedalaman Wilayah Potensi Dirasakan Shakemap} {set $data [dict get $gempa $data]}
