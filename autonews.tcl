...
proc detiknews {1 2 3 4 5} {
 ...
 foreach c [channels] {if {[channel get $c autonews] == 1} {putquick "privmsg $c :\002\detik.com\002 ($update) \0034-\003 $title \0034-\003 $link"}}
}
...
proc totabuan {1 2 3 4 5} {
 ...
 foreach c [channels] {if {[channel get $c autonews] == 1} {putquick "privmsg $c :\002\00304totabuan.co\003\002 ($update) \0034-\003 $title \0034-\003 $link"}}
}
...
proc selebtempo {1 2 3 4 5} {
 ...
 foreach c [channels] {if {[channel get $c autonews] == 1} {putnow "privmsg $c :\002seleb.\0034tempo.co\003\002 \($newsupdate\) \0034-\003 $title \0034-\003 $link"}}
}
...
proc newssport {1 2 3 4 5} {
 ...
 set update [clock scan $pubDate -format {%Y-%m-%dT%H:%M:%S.000Z} -timezone :UTC];
 set newsupdate [clock format $update -format {%d-%m-%y %H:%M %Z} -timezone :Asia/Jakarta];
 foreach c [channels] {if {[channel get $c autonews] == 1} {putnow "privmsg $c :\002bola.\0034tempo.co\003\002 \($newsupdate\) \0034-\003 $title \0034-\003 $link"}}
}
...
proc metrotempo {1 2 3 4 5} {
 ...
 set update [clock scan $pubDate -format {%Y-%m-%dT%H:%M:%S.000Z} -timezone :UTC];
 set newsupdate [clock format $update -format {%d-%m-%y %H:%M %Z} -timezone :Asia/Jakarta];
 foreach c [channels] {if {[channel get $c autonews] == 1} {putnow "privmsg $c :\002metro.\0034tempo.co\003\002 \($newsupdate\) \0034-\003 $title \0034-\003 $link"}}
}
...
proc gsmarenanews {1 2 3 4 5} {
 ...
 foreach c [channels] {if {[channel get $c autonews] == 1} {putquick "privmsg $c :\002\00304GSM\003Arena.com\002 ($update) \0034-\003 $title \0034-\003 $link"}}
}
