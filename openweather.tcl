...
proc pub:weather {n u h c t} {
 ...
 set cloud [dict get [lindex $weather 0] description]
 ...
 set dt [clock format $dt -format "%d %b %Y %H:%M:%S %Z" -timezone :Asia/Jakarta]
 ...
 putnow "PRIVMSG $c :\037Cuaca:\037 $name ($country) \0034-\003 $temp\°C ($feels\°C) \0034-\003 $cloud \0034-\003 \037Jarak Pandang:\037 $visibility\km \0034-\003 \037Kecepatan Angin:\037 $windspeed\m\/s \0034-\003 \037Tekanan:\037 $pressure\hPa"
 putnow "PRIVMSG $c :\037Awan:\037 $cloudcover\% \0034-\003 \037Kelembapan:\037 $humidity\% \0034-\003 \037Sunrise:\037 $sunrise \0034-\003 \037Sunset:\037 $sunset \0034-\003 \037Updated:\037 $dt"
}
