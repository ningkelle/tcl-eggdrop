...
proc autoadzan {1 2 3 4 5} {
 foreach chans [channels] {
  if {[channel get $chans autoadzan] == 1} {
   ...
   set adzanjson [json::json2dict $adzandata]; if {![dict exists $adzanjson code]} {return}
   if {[dict get $adzanjson code] != "200"} {set error [dict get $adzanjson data]; putnow "privmsg $chans :\0034ERROR:\003 $error"; return}
