...
proc pub:zdkdtk {n u h c t} {
 ...
 regsub -all "\n" $list "" data; regsub -all "</div>" $data "" data; regsub -all "&nbsp;" $data "" data; regsub -all "</strong>" $data "" data; regsub -all "&ndash;" $data " - " data;
 regexp {Peruntungan: (.*?)<br />} $data x peruntungan; regexp {s Zodiac(.*?)<br />} $data x peruntungan2
 ...
 regexp {Keuangan: ([^<]+)<br />} $data x keuangan
 regexp {Asmara: (.*?)<br />} $data x asmara
